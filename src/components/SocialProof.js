        ...
        <section id="social-proof" className=" py-6 sm:py-6">
            <div className="max-w-4xl mx-auto text-center p-6 sm:p-12">
                ...
                <a
                    ...
                    className="inline-block bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white font-bold py-3 px-8 rounded-lg shadow-lg hover:opacity-90 transition-all duration-300 transform hover:scale-105"
                >
