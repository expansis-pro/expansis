...
// Añadimos una nueva prop 'links' que por defecto será un array vacío.
const ImageTextCTA = ({ imageDesktop, alt, text, buttonContent, buttonLink, subtitle, title, imageSide = 'left', links = [] }) => {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-16">
            ...
            <div className={`mx-auto max-w-md lg:mx-0 ${imageOrderClass}`}>
            ...
            <div className={`text-center lg:text-left ${textOrderClass}`}>
                ...
                {/* Solo se muestra si la prop 'links' tiene elementos */}
                {links.length > 0 && (
