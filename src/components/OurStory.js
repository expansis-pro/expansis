...
const OurStory = () => {
    return (
        <section id="our-story" className="py-6 sm:py-6">
            <div className="max-w-4xl mx-auto lg:px-8 text-center">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
                    Nuestra Historia
                </h2>
                <div className="text-left font-light text-gray-700 space-y-4 text-justify">
                    <h3 className="text-xl text-primario font-semibold text-center">
