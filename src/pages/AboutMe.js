            ...
            <div className="max-w-6xl mx-auto">
                <ImageTextCTA
                    ...
                    text={[
                        ...
                        // --- CAMBIO REALIZADO ---
                        'También soy un amante de la música, mis gustos siempre están cambiando y expandiéndose. Un día puedo estar escuchando a Kidd Voodoo y al siguiente, volver a los clásicos como Led Zeppelin. Esta <strong>dualidad define mi enfoque profesional</strong>: entiendo la velocidad de las <strong>tendencias actuales</strong>, pero construyo sobre <strong>bases sólidas y estrategias que perduran</strong>.',
